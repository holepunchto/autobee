...
module.exports = class Systembee {
  ...
  async _migrate(info, { timeout } = {}) {
    ...
    if (!a._handlers.migrate) {
      throw new Error('Cannot migrate a legacy system without a migrate handler')
    }
