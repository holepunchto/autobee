...
module.exports = class Systembee {
  ...
  addAnchor(key) {
    // length starts at 0 - the anchor's single node applies through the
    // normal writer pipeline and bumps it, landing in the changes stream
    this.update(key, 0, -1, -1, false, true, false, false, true, -1, false)
  }
