...
const WriteBatch = require('./write-batch.js')
...
class Writer {
  ...
  async views() {
    ...
    // signedLength for autobase compat (WriteBatch.end is the signed view length)
    const system = WriteBatch.end(latest.views.system)
    const view = WriteBatch.end(latest.views.view)
