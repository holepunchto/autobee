...
class Writer {
  ...
  async views() {
    ...
    return [
      {
        key: latest.views.system.key,
        length: latest.views.system.end,
        signedLength: latest.views.system.end
      },
      {
        key: latest.views.view.key,
        length: latest.views.view.end,
        signedLength: latest.views.view.end
      }
    ]
  }
