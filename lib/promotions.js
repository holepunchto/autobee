...
// index holds exactly the outstanding work and the digest is just "is there
// any". A partial approval leaves the entry alone: the request still wants
// more than the tier that answered could give. Peers at that tier skip it on
// the hint, which is what keeps them from all answering the same request.
