...
const SystemGrants = getEncoding('@autobee/system-grants')
...
exports.encodeSystemGrants = encodeSystemGrants
exports.decodeSystemGrants = decodeSystemGrants
...
function encodeSystemGrants(m) {
  return c.encode(SystemGrants, m)
}

function decodeSystemGrants(value) {
  return c.decode(SystemGrants, value)
}
